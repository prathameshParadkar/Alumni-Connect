                    ...
                    <div className="flex flex-col-reverse ">
                        ...
                        <div>
                            <div className="flex justify-center space-x-4">
                                <div
                                    className={`relative w-24 mb-4 h-10 rounded-full border border-gray-300 text-black overflow-hidden ${selectedOption === "success"
                                            ? "bg-green-500"
                                            : "bg-gray-300"
                                        }`}
                                >
                                ...
                                <div
                                    className={`relative w-24 h-10 rounded-full border border-gray-300 text-black overflow-hidden ${selectedOption === "warn" ? "bg-yellow-500" : "bg-gray-300"
                                        }`}
                                >
                                    <input
                                        type="radio"
                                ...
                                <div
                                    className={`relative w-24 h-10 rounded-full border border-gray-300 text-black overflow-hidden ${selectedOption === "fail" ? "bg-red-500" : "bg-gray-300"
                                        }`}
                                >
                                    <input
                                        type="radio"
